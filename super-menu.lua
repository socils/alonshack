...
-- DESCRIPCIÓN: Administrador central de roles con jerarquías y transparencias corregidas.
-- =============================================================================
...
local Diccionario = {
    ES = {
        ...
        GuiaContenido = "• SELECTOR: Explora e inyecta los roles disponibles.\n• TECLA [ ` ]: Oculta o muestra este panel por completo.\n• HABILIDADES: Configura las variables de cada rol.",
        VolverRoles = "< ROLES",
        VolverAtras = "< VOLVER",
        ModoEdicionActivo = "MODO EDICIÓN: Arrastra los botones. Haz click aquí para guardar.",
    ...
    EN = {
        ...
        GuiaContenido = "• SELECTOR: Explore and inject available roles.\n• KEY [ ` ]: Hide or show this panel completely.\n• SKILLS: Configure each role's variables.",
        VolverRoles = "< ROLES",
        VolverAtras = "< BACK",
        ModoEdicionActivo = "EDIT MODE: Drag buttons. Click here to save.",
...
local CoreConfig = {
    ...
    ColorFondo = Color3.fromRGB(15, 17, 22),
    ColorTarjetas = Color3.fromRGB(24, 28, 36),
    RolesRegistrados = {},
    ModoDispositivo = "PC",
...
-- =============================================================================
-- ANIMACIÓN DE CARGA INTEGRADA
-- =============================================================================
local function SecuenciaDeCarga()
    local LoadingFrame = Instance.new("Frame")
    LoadingFrame.Size = UDim2.new(1, 0, 1, 0)
    LoadingFrame.BackgroundColor3 = Color3.fromRGB(10, 11, 14)
    ...
    local desaparecer = TweenService:Create(LoadingFrame, TweenInfo.new(0.3, Enum.EasingStyle.QuadIn), {BackgroundTransparency = 1})
    desaparecer:Play()
    TweenService:Create(TextoCarga, TweenInfo.new(0.2), {TextTransparency = 1}):Play()
    TweenService:Create(BarraFondo, TweenInfo.new(0.2), {BackgroundTransparency = 1}):Play()
    desaparecer.Completed:Connect(function() LoadingFrame:Destroy() end)
end

-- =============================================================================
-- INTERFAZ PRINCIPAL (DISEÑO PREMIUM DARK TECH REPARADO)
-- =============================================================================
...
MenuTitle.TextColor3 = Color3.fromRGB(230, 235, 245)
...
MinimizeBtn.Text = "─"
MinimizeBtn.TextColor3 = Color3.fromRGB(150, 155, 165)
...
PurgeBtn.Text = "✕"
PurgeBtn.TextColor3 = Color3.fromRGB(245, 95, 95)
...
-- =============================================================================
-- CAPAS DE NAVEGACIÓN INTERNA INTERMEDIARIAS (TRANSPARENCIAS REPARADAS)
-- =============================================================================
...
SuperHomeView.BackgroundTransparency = 1 -- Reparado: Evita bloqueo visual negro
SuperHomeView.BorderSizePixel = 0
...
IdleLabel.TextColor3 = Color3.fromRGB(110, 120, 135)
...
RoleView.BackgroundTransparency = 1 -- CORREGIDO: Evita que herede cuadros negros de fondo
...
BackToHomeBtn.BorderSizePixel = 0
BackToHomeBtn.Text = T("VolverRoles")
BackToHomeBtn.TextColor3 = Color3.fromRGB(210, 215, 225)
...
RoleContentScroll.BorderSizePixel = 0
...
SubMenuView.BackgroundTransparency = 1 -- CORREGIDO
...
BackToRoleBtn.BorderSizePixel = 0
BackToRoleBtn.Text = T("VolverAtras")
BackToRoleBtn.TextColor3 = Color3.fromRGB(210, 210, 215)
...
-- =============================================================================
-- CONTROLADORES DE INTERFAZ ABAJO (GUÍA, CRÉDITOS, IDIOMAS)
-- =============================================================================
...
DispositivoBtn.BackgroundColor3 = Color3.fromRGB(34, 40, 50)
DispositivoBtn.BorderSizePixel = 0
...
SwitchIdiomaBtn.BackgroundColor3 = Color3.fromRGB(34, 40, 50)
SwitchIdiomaBtn.BorderSizePixel = 0
...
EditarHUDBtn.BackgroundColor3 = Color3.fromRGB(42, 48, 60)
EditarHUDBtn.BorderSizePixel = 0
...
GuideFrame.BackgroundColor3 = Color3.fromRGB(20, 22, 28)
...
GuideContent.TextColor3 = Color3.fromRGB(150, 155, 165)
...
CreditsLabel.TextColor3 = Color3.fromRGB(85, 90, 105)
CreditsLabel.Font = Enum.Font.SourceSans
CreditsLabel.TextSize = 10
CreditsLabel.Parent = MainPanel

-- =============================================================================
-- LOGICA ARRASTRE HUD TRABAJADA
-- =============================================================================
local function HacerBotonArrastrableYConfigurable(boton)
...
-- =============================================================================
-- GESTIÓN DINÁMICA DE RE-RENDERIZADO DE IDIOMA
-- =============================================================================
local function ActualizarIdiomaInterfaz()
    ...
    BackToHomeBtn.Text = T("VolverRoles")
    BackToRoleBtn.Text = T("VolverAtras")
    EditarHUDBtn.Text = CoreConfig.ModModoEdicionHUD and T("ModoEdicionActivo") or T("EditarHUD")
    CreditsLabel.Text = T("Creditos")
...
EditarHUDBtn.MouseButton1Click:Connect(function()
    ...
    if CoreConfig.ModModoEdicionHUD then
        ...
        EditarHUDBtn.BackgroundColor3 = Color3.fromRGB(15, 90, 55)
    else
        EditarHUDBtn.Text = T("EditarHUD")
        EditarHUDBtn.BackgroundColor3 = Color3.fromRGB(42, 48, 60)
    end
...
-- =============================================================================
-- SISTEMA INTERACTIVO DE CONSTRUCCIÓN DE SUBMENÚS
-- =============================================================================
local function AbrirMenuDelRol(datosRol)
    ...
    if datosRol.Habilidades then
        datosRol.Habilidades(RoleContentScroll, function(nombreHabilidad, callbackConfig, dataHabilidadExtra)
            ...
            HabBtn.TextColor3 = Color3.fromRGB(210, 220, 230)
            ...
            if dataHabilidadExtra and dataHabilidadExtra.RequiereBotonHUD then
                ...
                BotonHUD.Size = UDim2.new(0, 52, 0, 52)
                BotonHUD.Position = UDim2.new(0, (#ContenedorBotonesHUD:GetChildren() * 58) % 200, 0, 40)
                BotonHUD.BackgroundColor3 = CoreConfig.ColorTarjetas
                ...
                BotonHUD.TextColor3 = Color3.fromRGB(255, 255, 255)
                ...
                AtajoText.BackgroundColor3 = Color3.fromRGB(45, 50, 65)
                ...
                HacerBotonArrastrableYConfigurable(BotonHUD)
...
_G.RegistrarNuevoRolEngine = function(data)
    ...
    RoleBtn.TextColor3 = Color3.fromRGB(220, 230, 240)
    ...
    RoleBtn.MouseEnter:Connect(function()
        TweenService:Create(RoleBtn, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(32, 38, 48), TextColor3 = colorDestaco}):Play()
    end)
    RoleBtn.MouseLeave:Connect(function()
        TweenService:Create(RoleBtn, TweenInfo.new(0.2), {BackgroundColor3 = CoreConfig.ColorTarjetas, TextColor3 = Color3.fromRGB(220, 230, 240)}):Play()
    end)
